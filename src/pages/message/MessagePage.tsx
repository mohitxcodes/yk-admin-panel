                        ...
                        {messages.map((msg) => (
                            ...
                            >
                                ...
                                <div className="flex-1 px-4 py-3 min-w-0">
                                    ...
                                    <p className="text-gray-200 text-sm whitespace-pre-line break-words line-clamp-3 pr-10">{msg.content}</p>
                                </div>
                                <button
                                    onClick={() => handleDelete(msg.id)}
                                    className="absolute top-2 right-2 z-10 px-2 py-1 rounded text-xs cursor-pointer font-semibold text-red-500 bg-white/10 hover:bg-red-100 hover:text-red-700 transition-all"
